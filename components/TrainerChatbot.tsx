...
const quickActions = [
    "Suggest a knee-friendly alternative for squats.",
    "Make this workout plan more beginner-friendly.",
    "Explain the 'Progressive Overload' principle.",
    "Add more core exercises to Day 3."
];
...
export default function TrainerChatbot({ plan }: { plan: PendingWorkoutPlan }) {
    ...
    return (
        <div className="bg-gray-900/50 rounded-lg border border-gray-700 h-[500px] flex flex-col">
                 ...
                 <div className="pt-2 flex flex-wrap gap-2">
                    {quickActions.map((action, index) => (
                        <button
                            ...
                            disabled={isLoading}
                            className="text-xs bg-gray-700/50 border border-gray-600 text-gray-300 px-2 py-1 rounded-full hover:bg-gray-600 disabled:opacity-50 transition-colors"
                        >
                            {action}
                        </button>
                    ))}
